...
function graphs_create_cpu($cpu,$period) {
    ...
    $data[] = array("cpu".$cpu."_load",         "FE962F","celkové vytížení cpu","854200","",                true,true,true,true,"%5.1lf %%");
    $data[] = array("cpu".$cpu."_load_system",  "",      "",                "003482","systémové   aplikace",true,true,true,true,"%5.1lf %%");
    $data[] = array("cpu".$cpu."_load_user",    "",      "",                "0D9D3E","uživatelské aplikace",true,true,true,true,"%5.1lf %%");
    $data[] = array("cpu".$cpu."_load_hardirq", "",      "",                "FBF54E","hardwarová přerušení",true,true,true,true,"%5.1lf %%");
    $data[] = array("cpu".$cpu."_load_softirq", "",      "",                "7E103C","softwarová přerušení",true,true,true,true,"%5.1lf %%");
...
function graphs_create_memory($period) {
    ...
    $data[] = array("mem_used",   "FE962F","celkové obsazení operační paměti","854200","",                                    false,true,true,true,"%6.2lf %SB");
    $data[] = array("mem_buffers","",      "",                                "003482","krátkodobá paměť pro diskové operace",false,true,true,true,"%6.2lf %SB");
    $data[] = array("mem_cached", "",      "",                                "0D9D3E","cache pro často používané soubory",   false,true,true,true,"%6.2lf %SB");
    $data[] = array("mem_active", "",      "",                                "FBF54E","obsazená paměť využívaná velmi často",false,true,true,true,"%6.2lf %SB");
    $data[] = array("mem_inact",  "",      "",                                "7E103C","obsazená paměť nevyužívaná často",    false,true,true,true,"%6.2lf %SB");
    $data[] = array("mem_mapped", "",      "",                                "666666","namapované soubory, hlavně knihovny", false,true,true,true,"%6.2lf %SB");
    $data[] = array("mem_slab",   "",      "",                                "7E13EC","vyrovnávací paměť pro součásti jádra",false,true,true,true,"%6.2lf %SB");
